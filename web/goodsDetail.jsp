    ...
    <div class="row">
        <div class="col-xs-6 col-md-6">
            <a href="#" class="thumbnail">
                ...
                <img src="${product.image}" width="560" height="560" alt="${product.name}"/>
            </a>
        </div>
            ...
            <div class="panel panel-default" style="height: 560px">
                ...
                <div class="panel-body">
                    ...
                    <div style="margin-left: 10px;">
                        <p>市场价格:&nbsp;&nbsp;&nbsp;
                            <span class="text-danger" style="font-size: 15px;">${product.price}</span>&nbsp;&nbsp;&nbsp;
                            <span class="glyphicon glyphicon-yen"></span>
                        </p>
                        <p>上市时间:&nbsp;&nbsp;&nbsp;${product.upTime}</p>
                        <p>热销指数:&nbsp;&nbsp;&nbsp;
                        ...
                        <p>详细介绍:</p>
                        <p>&nbsp;&nbsp;${product.info}</p>
                        <a href="${pageContext.request.contextPath}/cart?method=create&pid=${product.id}"
