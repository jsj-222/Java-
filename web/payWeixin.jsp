            ...
            <div class="panel panel-default" style="margin: 0 auto;width: 95%;">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <span class="glyphicon glyphicon-yen"></span>&nbsp;&nbsp;在线支付
                        <span class="pull-right">
                            <a href="${pageContext.request.contextPath}/getOrderList">返回订单列表</a>
				    	</span>
                    </h3>
                </div>
                    ...
                    <form action="http://ceshi.qfjava.cn/payment/weixinpay" method="get">
                        <table class="table table-bordered table-striped table-hover">
                            <tr>
                                <td colspan="1">订单号:</td>
                                <td colspan="3">
                                    <input type="text" class="form-control" name="orderId" value="${param.oid}" readonly="readonly">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <input type="text" class="form-control" name="body" value="xiaomi">
                                    <!-- 设置 程序回传到的链接地址 -->
