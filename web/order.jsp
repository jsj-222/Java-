...
<div class="container" style="background-color: white;">
                    ...
                    <td colspan="5">
                        ...
                        <select id="address" style="width:60%" class="form-control">
                            <c:forEach items="${addressList}" var="a" varStatus="ai">
                                <option value="${a.id}">${a.name}&nbsp;&nbsp;${a.phone}&nbsp;&nbsp;${a.detailAddress}</option>
                            </c:forEach>
                        </select>
    ...
    <div class="row pull-right" style="margin-right: 40px;">
        <div style="margin-bottom: 20px;">
            <button id="btn_add" onclick="createOrder(${loginUser.id},${sum})" class="btn  btn-danger btn-lg" type="button">提交订单</button>
        </div>
    </div>
</div>
