        ...
        <c:if test="${!empty list}">
            <div class="col-md-10 col-md-offset-1">
                <table class="table table-bordered table-striped table-hover">
                    ...
                    <c:forEach items="${list}" var="cart" varStatus="i">
                        <tr>
                            <th>${i.count}</th>
                                ...
                                <div class="input-group">
                                    <span class="input-group-btn">
                                        <button class="btn btn-default" type="button"
                                                onclick="sub(${cart.id},${cart.count},${cart.product.price})">-</button>
                                    </span>

                                    <input type="text" class="form-control" id="num_count${i.count}" value="${cart.count}"
                                           readonly="readonly" style="width:40px">

                                    <span class="input-group-btn">
                                        <button class="btn btn-default" type="button"
                                                onclick="add(${cart.id},${cart.count},${cart.product.price})">+</button>
                                    </span>
                                </div>
                            </th>
                            ...
                            <th>
                                <button type="button" class="btn btn-default" onclick="delCart(${cart.id})">删除</button>
                            </th>
                        </tr>
    ...
    <div class="row">
        <div class="pull-right" style="margin-right: 40px;">
            <div>
                ...
                <a href="${pageContext.request.contextPath}/order?method=preView&uid=${loginUser.id}"
                   class="btn  btn-danger btn-lg">添加收货地址</a>
            </div>
            <br><br>
