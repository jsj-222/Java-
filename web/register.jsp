...
<head>
    ...
    <script type="text/javascript">
        /*监听username输入框内容是否发生了变化,判断数据库中是否已经存在了当前用户!*/
        $(function () {
        ...
        <div class="center-block" style="margin-top: 80px;">
            <form class="form-horizontal" action="user?method=register" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8" style="width: 40%">
                        <input type="password" name="password" class="form-control col-sm-10" placeholder="Password"/>
                    </div>
                    <div class="col-sm-2">
                        <p class="text-danger"><span id="helpBlock1" class="help-block ">请不输入6位以上字符</span></p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8" style="width: 40%">
                        <input type="password" class="form-control col-sm-10" placeholder="Password Again"/>
                    </div>
                    <div class="col-sm-2">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8" style="width: 40%">
                        <input type="text" name="email" class="form-control col-sm-10" placeholder="Email"/>
                    </div>
                    <div class="col-sm-2">
