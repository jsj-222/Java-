...
<div id="dingdanxiangqing_body">
    <div id="dingdanxiangqing_body_big">
        <div id="big_left">
            ...
            <a id="big_left_a" href="orderList.jsp">我的订单</a><br/>
                                            ...
                                            <form action="address?method=update" method="post" class="form-horizontal">
                                                <div class="motal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" name="detailAddress" class="form-control" value="${address.detailAddress}">
                                                        </div>
                                                    </div>
                                                </div>
            ...
            <div class="container" style="width:960px;">
                <form action="address?method=add" method="post" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <textarea rows="3" class="form-control" name="detailAddress"></textarea>
                    </div>
