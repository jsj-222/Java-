        ...
        $(document).ready(function () {
            $.ajax({
                ...
                success: function (data) {
                    /*将商品类别渲染到页面中*/
                    /*[{'id':1,'name':'xxx','info':'yyy'},{},{}...]*/
                    for (var i in data) {
                        var a = $("<a href='${pageContext.request.contextPath}/product?method=show&tid=" + data[i].id + "'>" + data[i].name + "</a>");
                        $("#goodsType").append(a);
                    }
                },
                error: function () {
...
<div id="top">
    <div id="topdiv">
        ...
        <span style="float:right">
                ...
                <a href="${pageContext.request.contextPath}/cart?method=show&uid=${loginUser.id}" id="shorpcar">购物车</a>
            </span>
    </div>
</div>
